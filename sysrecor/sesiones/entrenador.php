	...
	<body class="subpage">
		...
		<!-- Header -->
			<header id="header">
                ...
                <li><a href="../abonos/vistaAbono.php">Abonos</a></li>
                <li><a href="../categoria/vistacatetgoria.php">categorias</a></li>
                <li><a href="../datospersonales/datospersonales.vista.php">Datos personales</a></li>
                <li><a href="../matricula/matricula.vista.php">Matriculas</a></li>
                <li><a href="../rol/vistaRol.php">Roles</a></li>
                <li><a href="../usuario/usuario.Vista.php">usuarios</a></li>
			  ...
			  <div class="inner">
				  <header class="align-left">
				    ...
				    <p> <iframe  align="center" src="../datospersonales/datospersonales.lista.php" target="objetivo"
name="objetivo" width="860" height="800" scrolling="no"></p>
				  </header>
				  <div class="image round right"> <img src="sesiones/images/pic01.png"> </div>
			  </div>
            </header>

		<!-- Three -->
			<section id="three" class="wrapper"></section>
